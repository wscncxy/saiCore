...
public final class FormatUtil {
	...
	/**
	 * 
	 * @Description: 比较obj值是否在[pre,last]区间，包含边界值
	 */
	public static boolean compareIsMiddle(BigDecimal pre,BigDecimal obj,BigDecimal last){
		if(pre.compareTo(obj) >= 0 && obj.compareTo(last) <= 0){
			return true;
		}
		return false;
	}
